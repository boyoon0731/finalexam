...
## Table 1 만들기
아래 데이터에서 Q로 시작하는 변수를 범주형으로 바꾼 후, 연도별 기술통계량을 Table로 나타내어라
(`jstable::CredentialTable)
...
```{r}
res.cox <- coxph(Surv(time, status) ~ rx + age + sex, data = colon, model = 1)
